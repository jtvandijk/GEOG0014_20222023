...
## Visualising data {-}
Based on the shapes of the streets and the outline of the street network, you may be able to recognise your allocated street already. However, we can also add something called a *base map* layer. A base map is a layer with geographic information that serves as a background and is incredibly useful when you want to add some context to your map. We do need a little plugin to add this base map. We can do that as follows:
...
- One submission per group. Make sure to include the [group work coversheet](https://moodle.ucl.ac.uk/course/view.php?id=26400)) in your submission and you follow the [guidelines for group submissions](https://moodle.ucl.ac.uk/course/view.php?id=26400)). 
